...
public class UserDetails implements Serializable, Comparable
{
	...
	public String toString() {
		return "UserDetails [firstName=" + firstName + ", lastName=" + lastName + ", birthCity=" + birthCity
				+ ", birthState=" + birthState + ", birthCountry=" + birthCountry + ", birthYear=" + birthYear
				+ ", birthMonth=" + birthMonth + ", birthDate=" + birthDate + ", birthHour=" + birthHour
				+ ", birthMinute=" + birthMinute + ", birthSecond=" + birthSecond + ", lon_deg=" + lon_deg
				+ ", lon_min=" + lon_min + ", lon_sec=" + lon_sec + ", lat_deg=" + lat_deg + ", lat_min=" + lat_min
				+ ", lat_sec=" + lat_sec + ", timeZoneOffset=" + timeZoneOffset + ", dstOffset=" + dstOffset + ", sex="
				+ sex + ", isNorth=" + isNorth + ", isEast=" + isEast + ", id=" + id + "]";
	}


	public int compareTo(Object anotherNative) throws ClassCastException
	{
		if (!(anotherNative instanceof UserDetails)) throw new ClassCastException ("A BirthData object expected.");
		String anotherNativeLastName = ((UserDetails) anotherNative).getLastName();
	...
	public static Comparator FirstNameComparator = new Comparator()
	{
		...
		{
			String lastName1 = ((UserDetails) firstNative).getLastName().toUpperCase();
			String firstName1 = ((UserDetails) firstNative).getFirstName().toUpperCase();
			String lastName2 = ((UserDetails) anotherNative).getLastName().toUpperCase();
			String firstName2 = ((UserDetails) anotherNative).getFirstName().toUpperCase();
