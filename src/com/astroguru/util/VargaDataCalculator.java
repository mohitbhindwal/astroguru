			...
			switch(varga)
			{
				case 0:
					...
					{	
						...
						System.out.print(allPlanets.getPlanet(Constants.planetLongNames[i]) + "Rasi Positions: " + vargaDataArray[0][i] + "\n");
					}
					
					
					
				 //	House firsthouse = new House(1, null, null, new Sign(vargaDataArray[0][13]));
				//	rashChart.addHouse(house);
